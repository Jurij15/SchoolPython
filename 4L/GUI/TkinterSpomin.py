...
def narisi(platno):
    ...
    for i in range(20):
        ...
        if odkrito[i]:
            ...
            platno.create_text(polozaj, fill="white", text=str(komplet[i]), font=("Times", VEL // 2))
...
def znova():
    ...
    odkrito = [False] * 20  # Vse ploščice so neodkrite
    ploscice = list(range(12))
